...
if($security_key == "12345"){
	...
	$machine_list=mysqli_query($link,"SELECT machine1,machine2,machine3,machine4,machine5,machine6,machine7,machine8,machine9,machine10 FROM `tabmachineallocation` WHERE tabmachineallocation.tabid= (SELECT androidtokens.tabid FROM `androidtokens` WHERE androidtokens.imei_number= '".$imei_number."' )  ORDER BY tabmachineallocation.timeadded DESC LIMIT 1 ");
