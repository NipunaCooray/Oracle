...
<head>
        <title>KODAMS</title><meta charset="UTF-8" />
    ...
    <body>
        ...
        <?php
         ...
         ?>
            ...
            <form id="loginform" class="form-vertical" action= "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); 
            ?>" method="post">
